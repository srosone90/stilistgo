...
export function storageGetSuppliers(): Supplier[] { return getList<Supplier>(K().suppliers); }
export function storageSaveSuppliers(data: Supplier[]): void { saveList(K().suppliers, data); }
